...
const FeaturedPosts = () => {
  ...
  const customLeftArrow = (
    <ArrowFix>
      <div className="absolute arrow-btn left-0 text-center py-3 cursor-pointer bg-sky-900 rounded-full">
  ...
  const customRightArrow = (
    <ArrowFix>
      <div className="absolute arrow-btn right-0 text-center py-3 cursor-pointer bg-sky-900 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 text-white w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
